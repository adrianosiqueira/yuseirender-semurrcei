...
//metodo para trazer todos equipamentos do banco de dados
 ...
 public ArrayList selecionarAllEquipPorAlugado(String alugado) throws SQLException
 {
    ...
    public ArrayList<Equipamento> selecioneAllEquipamentoTomboStringEquip(String equip) throws SQLException
    {
    ...
    public ArrayList<Equipamento> selecioneAllEquipamentoSerie() throws SQLException
    {

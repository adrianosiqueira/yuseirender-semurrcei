...
public class RelatorioStatus 
{
    ...
    public void gerarPDF(String status)
    {
        ...
        try
        {
            ...
            //Destino do arquivo
            String nomearquivo = "S:\\NTI\\DIGITALIZADOS\\SEMUR CONTROLE ESTOQUE\\RelatorioStatus"+data2+".pdf";
            ...
            PdfPCell CELULATitulo = new PdfPCell(new Paragraph("RELATORIO EQUIPAMENTOS POR STATUS: "+status, FontFactory.getFont(FontFactory.TIMES_BOLD, 13f)));
            ...
            try
            {
                ...
                "fornecedor as f on e.fornecedor = f.id inner join fabricante as fab on e.fabricante = fab.id where e.status = ?";     

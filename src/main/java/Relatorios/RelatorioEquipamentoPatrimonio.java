...
public class RelatorioEquipamentoPatrimonio 
{
    
    public void gerarPDF(String patrimonio)
    {
        ...
        try
        {
            ...
            //Destino do arquivo
            String nomearquivo = "S:\\NTI\\DIGITALIZADOS\\SEMUR CONTROLE ESTOQUE\\RelatorioEquipamentoPatrimonio"+data2+".pdf";
            ...
            PdfPCell CELULATitulo = new PdfPCell(new Paragraph("RELATORIO EQUIPAMENTOS PATRIMONIO: "+patrimonio, FontFactory.getFont(FontFactory.TIMES_BOLD, 13f)));

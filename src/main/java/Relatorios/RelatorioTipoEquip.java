...
public class RelatorioTipoEquip 
{
    
    public void gerarPDF(String tipoequipamentonome)
    {
        ...
        try
        {
            ...
            //Destino do arquivo
            String nomearquivo = "S:\\NTI\\DIGITALIZADOS\\SEMUR CONTROLE ESTOQUE\\RelatorioTipoEquip"+data2+".pdf";
            ...
            PdfPCell CELULATitulo = new PdfPCell(new Paragraph("RELATORIO EQUIPAMENTOS POR TIPO EQUIPAMENTO: "+tipoequipamentonome, FontFactory.getFont(FontFactory.TIMES_BOLD, 13f)));
            ...
            try
            {
                ...
                "fornecedor as f on e.fornecedor = f.id inner join fabricante as fab on e.fabricante = fab.id where tp.tipoequipamentonome = ?";     

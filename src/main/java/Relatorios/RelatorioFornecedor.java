...
public class RelatorioFornecedor 
{
    ...
    public void gerarPDF(String fornecedor)
    {
        ...
        try
        {
            ...
            //Destino do arquivo
            String nomearquivo = "S:\\NTI\\DIGITALIZADOS\\SEMUR CONTROLE ESTOQUE\\RelatorioFornecedor"+data2+".pdf";
            ...
            PdfPCell CELULATitulo = new PdfPCell(new Paragraph("RELATORIO EQUIPAMENTOS POR FORNECEDOR: "+fornecedor, FontFactory.getFont(FontFactory.TIMES_BOLD, 13f)));
            ...
            float[] columnWidths = new float[]{23f, 35f, 23f,35f,34f,28f,34f,35f};
            ...
            try
            {
                ...
                String sql = "select * from equipamento as e inner join unidade u on e.unidade = u.id inner join tipoequipamento as tp on e.tipoequip = tp.id\n"+
                "inner join fornecedor as f inner join fabricante as fab on e.fabricante = fab.id where f.fornecedornome = ?";   

...
public class RelatorioTipoEquipFornecedorEquip 
{ 
    
    public void gerarPDF(String tipoequip, String campo, String fornecedor) 
    {
    ...
    int contador = 0;            
        ...
        try
        {
            ...
            //Destino do arquivo
            String nomearquivo = "S:\\NTI\\DIGITALIZADOS\\SEMUR CONTROLE ESTOQUE\\RelatorioTipoEquipFornecedorEquip"+data2+".pdf";
            ...
            //Cria um paragrafo e alinha ao centro
            Paragraph psubtitulo = new Paragraph("| - SISTEMA DE CONTROLE DE EQUIPAMENTOS - |"
            +tipoequip+" "+campo+" "+fornecedor, FontFactory.getFont(FontFactory.TIMES_BOLD, 12f));
            ...
            PdfPCell CELULATitulo = new PdfPCell(new Paragraph("RELATORIO EQUIPAMENTOS ALUGADOS", FontFactory.getFont(FontFactory.TIMES_BOLD, 13f)));
            ...
            float[] columnWidths = new float[]{23f, 35f, 23f, 23f,35f,34f,28f,34f};
            ...
            try
            {
                ...
                String sql = "select * from equipamento as e inner join unidade u on e.unidade = u.id inner join tipoequipamento as tp on e.tipoequip = tp.id inner join fornecedor as f on e.fornecedor = f.id inner join fabricante as fab on e.fabricante = fab.id where tp.tipoequipamentonome = ? and f.fornecedornome = ? and e.equipamento = ?";     
        
                pstm = conexao.prepareStatement(sql);
                
                pstm.setString(1, tipoequip);

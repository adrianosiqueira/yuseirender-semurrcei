...
public class RelatorioEquipamentoConvenio
{
    
    public void gerarPDF(String convenio)
    {
        ...
        try
        {
            ...
            //Destino do arquivo
            String nomearquivo = "S:\\NTI\\DIGITALIZADOS\\SEMUR CONTROLE ESTOQUE\\RelatorioEquipamentoConvenio"+data2+".pdf";
            ...
            PdfPCell CELULATitulo = new PdfPCell(new Paragraph("RELATORIO EQUIPAMENTOS CONVENIO: "+convenio, FontFactory.getFont(FontFactory.TIMES_BOLD, 13f)));

...
public class RelatorioUnidade 
{
    ...
    public void gerarPDF(String unidadenome)
    {
        ...
        try
        {
            ...
            //Destino do arquivo
            String nomearquivo = "S:\\NTI\\DIGITALIZADOS\\SEMUR CONTROLE ESTOQUE\\RelatorioUnidade"+data2+".pdf";
            ...
            PdfPCell CELULATitulo = new PdfPCell(new Paragraph("RELATORIO EQUIPAMENTOS POR UNIDADE: "+unidadenome, FontFactory.getFont(FontFactory.TIMES_BOLD, 13f)));

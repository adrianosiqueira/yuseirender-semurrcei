...
public class RelatorioEquipamentoAlugado
{
    
    public void gerarPDF(String alugado)
    {
        ...
        try
        {
            ...
            //Destino do arquivo
            String nomearquivo = "S:\\NTI\\DIGITALIZADOS\\SEMUR CONTROLE ESTOQUE\\RelatorioEquipamentoAlugado"+data2+".pdf";
            ...
            PdfPCell CELULATitulo = new PdfPCell(new Paragraph("RELATORIO EQUIPAMENTOS ALUGADOS: "+alugado, FontFactory.getFont(FontFactory.TIMES_BOLD, 13f)));
